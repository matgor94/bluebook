...
<div class="sidenav">
    <div class="login-main-text">
        <h2>Projekt New Blue Book<br> Strona logowania</h2>
    </div>
</div>
<div class="main">
    <div class="col-md-6 col-sm-12">
        <div class="login-form">
            <form method="post" action="/login">
                ...
                <div class="form-group">
                    <label>Hasło</label>
                    <input type="password" class="form-control" placeholder="hasło" name="haslo" id="password" required="true">
                    <div align="start">
                ...
                <a href="" class="btn btn-secondary">Zarejestruj</a>
            </form>
